...
class CreateCoach extends React.Component {
    ...
    submitHandler = (event) => {
        ...
        this.props.createNewCoach( this.state.controls.name.value, this.state.controls.email.value, this.state.controls.address.value, this.state.controls.about.value, this.state.controls.instagram.value,this.state.controls.facebook.value, this.state.controls.telegram.value, this.state.controls.roleMethod.value, this.state.controls.planMethod.value, this.state.controls.stateMethod.value)
    }
                    ...
                    <div className="row">
                        <div className="col-md-offset-3">
                            ...
                            <form onSubmit={this.submitHandler}>
                                ...
                                <Button btnType="btn-success">ایجاد مربی جدید</Button>
                            </form>
...
const mapDispatchToProps = dispatch => {
    return {
        createNewCoach: (name, email, address, about, instagram,facebook, telegram, role, payPlan, city) => dispatch(actionTypes.createNewCoach(name, email, address, about, instagram,facebook, telegram, role, payPlan, city ))

    }
}

export default connect(null, mapDispatchToProps)(CreateCoach);
